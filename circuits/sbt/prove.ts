...
// Generate a proof for the `latest` tag of the `sbt` circuit.
// The `sbt` circuit name is specified in the `name` field of `./sbt/sindri.json`.
const circuitIdentifier = 'sbt:latest';
