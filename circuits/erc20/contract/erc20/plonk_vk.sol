// Verification Key Hash: 165b842d4afb05772de05909dc7324cbd05e7362a062ad2c706bba2b21fc3398
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x165b842d4afb05772de05909dc7324cbd05e7362a062ad2c706bba2b21fc3398;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x021e23d9288e0078f23facc9fbcba251b33b67808772265802a0d68db107d5d3) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x2d6f17e05229d158f9bfc44d6148abf9aec21781358b126f6ca0242606c08b7f) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x12fd2d540e7cf0cb361ecb1f123b1b9e308a4ddefa3bf6fb1e610a9e4d9a1892) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x010caddf1c1fa51612eb3a9c560bd8776ec86d2e3e5c5986cf0fc245a17e4aa6) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x1568d3a8e993dcf5e368b1086553fa03bcd825a2663c7758a9598ad0abca9968) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x00ca96e8abbd79b490ec627f179f2895cb0721f5f783138bce11324f77f1acd1) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x01aadcd5c75a543f231205573915932adb1933d5a64254798c59650eb1f34a33) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x09ea751291b124b9648dd6806f9971589a2e14ab4dca70900865e6258b5b2be3) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x01bfd62f21ac0aad367cd794009be3903d03cdd1b6d0800dd96de683fe994bb5) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x021f8cee43662ec759ff48cb0b9f2dd0f42dc27293bff8c1ad2ee3e59dbbfaf6) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x20b48a9ce0419d2f456e9e965c3d05c200a1806836c5e1890bc22d7593ff1432) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x249d6237f8b4f950d2f5ace253daa14ba57606878be164d032883affbb5dcd1d) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x0f89b7bed5636c3f0d10ab6ed577e08ab9c91691f31046d56ba94c81b9c3608c) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x252b6ffa01a5fbec83c6b4e7f58a3bfe4fa6d6ece6bec66515a9922b2c9214d3) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x088f6ef568dde8eaf0db772aed3e5e15eef150ed5e3cdf7df98f29f20be22176) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x144d036dc6a6b3b1c4d1ae6ced2e36c95b0ec488b41b960c721b00f9d0de7432) // vk.QSORT.y
            mstore(add(_vk, 0x280), 0x10bba121f4314a89247da6fb7d1bdd031e24e50a3fc6717a4dd39df1d70da700) // vk.Q_ELLIPTIC.x
            mstore(add(_vk, 0x2a0), 0x27ce274797ab5ad3f576751c70ed53acbca22b498355fd9bdfd41a01b506b170) // vk.Q_ELLIPTIC.y
            mstore(add(_vk, 0x2c0), 0x2df8cf2b28f7b6ff8a59934e56d78004cae9ec870e8c4f5484b47d6ac3156aa4) // vk.Q_AUX.x
            mstore(add(_vk, 0x2e0), 0x2bfd677b64f7df45f2b192455ada3383c9cfbec36308c5c135e76da834922bc2) // vk.Q_AUX.y
            mstore(add(_vk, 0x300), 0x091793309d94e01420f806acc0f0c8b8ddfd964c17b7da8e4187d28b3e3d2c08) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x12161e0755cd2122be662e46b71168274d51ea3eac277c5e3920d9b46f056020) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x2d1b90356881f489037a1bed5a5b2af6a96a53c2a2df3fce10b834cdca824c8c) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x1d6c0d85a43cbbb8f381ad32d6c2d5bf2df68ee886e5426f417e542beabd1f62) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x066f7e35622a3b951b9135d9bb1bfcf84e70b7bdbde42f5aa2dc52c8e3588afc) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x2c6c2c030d76ba808cd4319e5ddc27873bb2439e05f0361f4ad5b5d719143076) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x1081e20d031bcd2571e313d2972051fdced308b0ffa2bdff94a8f7dd21c77b3f) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x234c5270ac171ca74681768ee52ff9e0c99affc2a818c5c44b7e44c5be7442fc) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x500), 0x0fba3f84ebbf0cbeec1882a2c0e9fed54d1317bb008a3152a2d880f19e09eb1f) // vk.TABLE_TYPE.x
            mstore(add(_vk, 0x520), 0x2e9f0f750366def1815914b6efffcb1b3dd15e52ad7188f86384fe317f943424) // vk.TABLE_TYPE.y
            mstore(add(_vk, 0x540), 0x15c3d734e06c5168742aadcfa12fd37179cc3f08f2297a76d4b72ce7f6e49707) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x0ee9348fd1d22ca107c5f2534220e3c4373a7533b593ae957cf6bcd0e6deb8ee) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x1c079fe3c9d4a5bc85a7cfcc6ca5c2499f3eee13b50792ec8ce8796f79d883bc) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x149f006cc0a477d280fc5a86fbe3f3f3e619948ca05eb33cbdb8c5bf4fa2a29e) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x153e394d5309a051fdb762e857f9331b4db8921627978e9c0de3f2cfc64144d9) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x0a8edbcadc0bcff9ed627eb4884e8944ec6a2f6139d9e18aecc2b887ef011116) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x0d6e738f6fa9201db881acad7c70c6cd97b0bb05b48097199f26b4419e680f10) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x29b703fe27071b48d7bab847a6e33fda7b4c7485b4ec2ee4607c17da7cbb14b4) // vk.ID4.y
