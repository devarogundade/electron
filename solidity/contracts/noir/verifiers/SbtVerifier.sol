// Verification Key Hash: 7ff014a0f88f1ecee43d48bc393dfa23db64bb018c83012d72de1f399b3a9af0
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns (bytes32) {
        return
            0x7ff014a0f88f1ecee43d48bc393dfa23db64bb018c83012d72de1f399b3a9af0;
    }
    ...
    function loadVerificationKey(
        ...
        assembly {
            ...
            mstore(
                add(_vk, 0x80),
                0x1c72f8afaf2f3a3086625e946f5ff1cb776ee3fd58d849ec4c78fd7bce4a77dd
            ) // vk.Q1.x
            mstore(
                add(_vk, 0xa0),
                0x275e91ba90107d284a1a22e68e793e010240056972da830a29e15a967407fb91
            ) // vk.Q1.y
            mstore(
                add(_vk, 0xc0),
                0x16c8c5c19f2bf51c49c5ee261230821f5fddf50fb66b0ee7d5e3a7601a2dc588
            ) // vk.Q2.x
            mstore(
                add(_vk, 0xe0),
                0x1861e3a6fe9ba15df9ffdd63914c9617eb8528f59e5417774760874e3f56fd57
            ) // vk.Q2.y
            mstore(
                add(_vk, 0x100),
                0x1382a2c13013108438e6fc6957b2f745bcf2206c5c7f7a2782c0d5704eb22fe4
            ) // vk.Q3.x
            mstore(
                add(_vk, 0x120),
                0x1c718633b22726a8a9c6a793ff3de226636d0c20f2f0e0ecf865c055b61b5f60
            ) // vk.Q3.y
            mstore(
                add(_vk, 0x140),
                0x0515b8e737730b1c649723735d89229ca63dda58c8312b58de04f5a6b621bb04
            ) // vk.Q4.x
            mstore(
                add(_vk, 0x160),
                0x159a9ffb05337fef67678ad6294decf7652e30e10e226b1d3c10ece90aa07c2c
            ) // vk.Q4.y
            mstore(
                add(_vk, 0x180),
                0x1b471dfd236121b1c05e402df47bff39e9303ea9c4d606fe0065861963319afb
            ) // vk.Q_M.x
            mstore(
                add(_vk, 0x1a0),
                0x027fdbdcc2d126da55eb14e47343b528510ad416b1f2208f5abe9ff223cc2df3
            ) // vk.Q_M.y
            mstore(
                add(_vk, 0x1c0),
                0x129582e29f56b99747f0c628d3d91ea862c618b15e5478ba569e719bc7fab092
            ) // vk.Q_C.x
            mstore(
                add(_vk, 0x1e0),
                0x022fdf048c855f9839a909e0fe2f63f7fd08b7640614e40ab6bb397a1fc1ebe7
            ) // vk.Q_C.y
            mstore(
                add(_vk, 0x200),
                0x2d94767a959b3ab689e5d5b4515bf5c64e1e7eeac90939ed5941c2a8f90a1755
            ) // vk.Q_ARITHMETIC.x
            mstore(
                add(_vk, 0x220),
                0x24d2664dc015ebeee747636e5ebc30f49f035508a7c3b4cb8543106ad4d640ff
            ) // vk.Q_ARITHMETIC.y
            mstore(
                add(_vk, 0x240),
                0x2183251edb400f7d6089d8cec70c33d42712771392c0d128dd0f5b0d34f1ae0b
            ) // vk.QSORT.x
            mstore(
                add(_vk, 0x260),
                0x1c7abd90de23e7ae38695134c1f994145a0a802d1d313138ab9519bcccf04eb6
            ) // vk.QSORT.y
            mstore(
                add(_vk, 0x280),
            ...
            mstore(
                add(_vk, 0x2c0),
                0x298f550191ad1f06766cc49bdd029f60dcb49a8a5261adc05ad8da6fbe3667c0
            ) // vk.Q_AUX.x
            mstore(
                add(_vk, 0x2e0),
                0x272392e7ad160512f4b8ecc4dd888292f7bc2c1e95276d53fee50cc05ce05e6c
            ) // vk.Q_AUX.y
            mstore(
                add(_vk, 0x300),
                0x0d3c7ad40e931285628ab95823dfd5f2b39a373c9fc822636e23055596afae6c
            ) // vk.SIGMA1.x
            mstore(
                add(_vk, 0x320),
                0x0f301153e3b275ae2c07e011a716f841ff16179b6ad230f1cfb8b22048cfad9f
            ) // vk.SIGMA1.y
            mstore(
                add(_vk, 0x340),
                0x10862a6e98de9993f6e9524cd5d5fff7a2622196519b83d4132f3e9a64a8c63c
            ) // vk.SIGMA2.x
            mstore(
                add(_vk, 0x360),
                0x10a3b1b6f60672a9c8e0a68ea341d1c6cea98d4dcbb803a75ce771258fbd828e
            ) // vk.SIGMA2.y
            mstore(
                add(_vk, 0x380),
                0x05459c6defb506c578096354bf882d04b7a4365d805edb9dc33dec21777e2955
            ) // vk.SIGMA3.x
            mstore(
                add(_vk, 0x3a0),
                0x1c7ef0c99020ed13d3298106a4f99f6d90d8a7e9f85a3bd69a10469a0771578d
            ) // vk.SIGMA3.y
            mstore(
                add(_vk, 0x3c0),
                0x2401843c903d964a638422a65ead8002476a4160bb2ee945abf72eca02dca156
            ) // vk.SIGMA4.x
            mstore(
                add(_vk, 0x3e0),
                0x0b1de4cc431ff9d6b4ea077abafe5963b21f634b528187c6cbc2f78914d43749
            ) // vk.SIGMA4.y
            mstore(
                add(_vk, 0x400),
            ...
            mstore(
                add(_vk, 0x500),
                0x05a58d31323b7809ccbc4c2721cb4da7731a50882aef094792b99725e0b871bd
            ) // vk.TABLE_TYPE.x
            mstore(
                add(_vk, 0x520),
                0x0513444adf2cbeb8b1246dc3fe101584ae0fcd2205bdbf1645dfa5bc46a6b898
            ) // vk.TABLE_TYPE.y
            mstore(
                add(_vk, 0x540),
                0x0a49bcd670d1d27c3939236f40e931e40393c11b255d2793647c0e8fd39a873b
            ) // vk.ID1.x
            mstore(
                add(_vk, 0x560),
                0x0dc38dd7bb463c26a5ec0053c1c471452ccbe07ce9c1c266ef834b02e9b09348
            ) // vk.ID1.y
            mstore(
                add(_vk, 0x580),
                0x1056c904173d1deca4b2abcb2cdde542940bcf63fbad932525ef506d523a9e9a
            ) // vk.ID2.x
            mstore(
                add(_vk, 0x5a0),
                0x1ea77be3aa06c47515ee86df8420d9f9c80384313472ce8a062b2840c55432f3
            ) // vk.ID2.y
            mstore(
                add(_vk, 0x5c0),
                0x14c2710bb5441634f0a9c124f9cbd132ff61fce97dc752319c57a446f84e4cd5
            ) // vk.ID3.x
            mstore(
                add(_vk, 0x5e0),
                0x09400ad623ac23e30f5532c8e417c8b1b6783f19984dd3ca82448ca2caa56431
            ) // vk.ID3.y
            mstore(
                add(_vk, 0x600),
                0x198b2e0a0eadf2a92025cc59744e161ed67b4d14d04ff9d7b5eb5181dc212ab0
            ) // vk.ID4.x
            mstore(
                add(_vk, 0x620),
                0x2916dd43238cb26224d280a4b765c1661888c1e64002e1e29e0acfb702c0d2d5
            ) // vk.ID4.y
...
contract SbtVerifier is BaseUltraVerifier {
